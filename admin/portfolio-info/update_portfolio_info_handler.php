...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Prepare the update SQL statement if there are fields to update
    ...
    foreach ($slideimages['name'] as $key => $slideimage) {
        ...
        if (move_uploaded_file($slideimages['tmp_name'][$key], $target_file)) {
            ...
            if (isset($existing_images[$key])) {
                ...
                // If there are no existing images, you might want to insert new images instead
    ...
    if (isset($_SESSION['user_id'])) {
        $log_entry = "Updated portfolio item ID: $portfolio_item_id.";
